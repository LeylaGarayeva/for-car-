...
namespace _12._05._2017
{
    class Cars
    {
        ...
        private double fuelUsage=10;// benzin serfiyyati
        private int fuelCapacity=20;//movcud  benzin
        private double fuelCurrent=100; // bakin obsi hecmi
        private double qaliq;
        ...
        public double ferq(double s)
        {
            double qaliq = (this.fuelCurrent + s) - (this.FuelCapacity);
            return qaliq;
